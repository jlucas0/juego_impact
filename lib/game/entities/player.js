ig.module("game.entities.player")
    ...
    .defines(function() {
        ...
        EntityPlayer = ig.Entity.extend({
            ...
            // Sonidos
            coinSound: new ig.Sound( 'media/sounds/effects/moneda.ogg'),
            stepsSound: new ig.Sound( 'media/sounds/effects/pasos.ogg',false),
            stepSoundEnd: true,
            jumpSound: new ig.Sound( 'media/sounds/effects/salto.ogg',false),
            hitSound: new ig.Sound( 'media/sounds/effects/impacto.ogg',false),
            timeoutSound: new ig.Sound( 'media/sounds/effects/muerte.ogg'),
            ...
            update: function() {
                ...
                if(!ig.game.paused){
                    ...
                    if(!this.death){
                        ...
                        if(this.speed != 0 && this.standing && this.stepSoundEnd){
                            this.stepSoundEnd = false;
                            this.stepsSound.play();
                        }
                        if(this.stepsSound.currentClip && this.stepsSound.currentClip.ended){
                            this.stepSoundEnd = true;
                        }
